...
const { loginSchema, emailSchema, tokenSchema, tokenAndPasswordSchema, changePasswordSchema } = require('../validations/auth.schema')

const router = require('express').Router()

router.post('/login', validate(loginSchema), authController.login)
router.get('/me', authMiddleware, authController.me)
router.post('/validate-token', validate(tokenSchema), authController.validateToken)
